    ...
    <section class="store-cart">
        <div class="container">
                            ...
                            <tr>
                                ...
                                <td style="width: 20%">
                                    <form action="{{ route('cart-delete', $cart->id ) }}" method="POST">
                                        @method('DELETE')
                                        @csrf
                                        <button href="#" class="btn btn-remove-cart"> Remove </button>
                                    </form>
                                </td>
                            </tr>
            ...
            <div class="row" data-aos="fade-up" data-aos-delay="150">
                ...
                <div class="col-12">
                    <h2 class="mb-4">Snipping Details</h2>
                </div>
            </div>
                ...
                <div class="row mb-2" data-aos="fade-up" data-aos-delay="200">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="address_one">Adress 1</label>
                            <input type="text" class="form-control" id="address_one" name="address_one" value="Florida, California" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="address_two">Adress 2</label>
                            <input type="text" class="form-control" id="address_two" name="address_two" value="Block B, No.1" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="zip_code" name="zip_code" value="40124" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="phone_number" name="phone_number" value="+62 8123 4567 8982" />
                        </div>
                    </div>
                </div>
                <div class="row" data-aos="fade-up" data-aos-delay="150">
