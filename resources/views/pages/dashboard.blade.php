                ...
                <div class="col-md-4">
                    <div class="card mb-2">
                        <div class="card-body">
                            ...
                            <div class="dashboard-card-subtitle">@number($customer)</div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="card mb-2">
                        <div class="card-body">
                            ...
                            <div class="dashboard-card-subtitle">@number($transaction_count)</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12 mt-2">
                    ...
                    <a href="{{ route('dashboard-transaction-details', $transaction->id) }}" class="card card-list d-block">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-1">
                                    <img src="{{ Storage::url($transaction->product->galleries->first()->photos ?? '') }}" alt="" class="w-50" />
                                </div>
